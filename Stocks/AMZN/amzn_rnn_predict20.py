...
# Source: https://www.udemy.com/course/deeplearning/learn/lecture/6730148#questions/3554002
...
#dataset_train = pd.read_csv('./datasets/AMZN.csv')
...
dataset_all = pd.read_csv('./datasets/AMZN.csv')
dataset_train, dataset_test = create_training_test(dataset_all, testing_records)
...
n_future = 5  # Number of days you want to predict into the future
